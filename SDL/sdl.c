/**
*\file sdl.c
*\brief Fichier contenant la SDL, permettant d'afficher une interface graphique du menu du jeu de l'Othello, puis d'y jouer
...
int main(int argc, char** argv)
{
    ...
    SDL_Surface* surface = NULL,*fond = NULL,*regle = NULL, *texte = NULL, *texte1 = NULL, *texte2 = NULL, *texte3 = NULL, *cercle = NULL, *croix = NULL;  /** création de variables surfaces pour afficher du texte ou des images **/
    SDL_Texture *texture, *texture1, *texture2, *texture3, *c1,*c2, *fd, *r;  /** creation de textures pour affichages du texte **/
	SDL_Rect pos;  /** déclaration rectangle pos pour position du curseur **/
