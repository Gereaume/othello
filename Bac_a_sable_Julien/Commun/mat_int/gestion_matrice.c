...
void init_tab(int tab[54]){
	
	int i;																		/** Declaration des variables a incrementer	**/

	for(i=0;i<54;i++)																/** Incrementation de ligne	**/
	{
		tab[i] = 0;														/** On place des étoile dans chaque case **/
	}
}
